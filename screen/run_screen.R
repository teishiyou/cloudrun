...
source('/app/benchling/screen/R/seq.R')
source('/app/benchling/screen/R/utils.R')
source('/app/benchling/screen/R/screen.R')
source('/app/benchling/screen/R/check.R')
source('/app/benchling/screen/R/checkReads.R')
source('/app/benchling/screen/R/checkContig.R')
...
## load param.yaml
## -------------------------------------
if (file.exists('/app/benchling/screen/param.yaml')==FALSE){
    stop('param.yaml not found.')
}

log_info('loading param.yaml...')

yaml <- yaml.load_file('/app/benchling/screen/param.yaml')
...
readme <- read_excel('/app/benchling/screen/misc/readme.xlsx', sheet='readme')
description_column <- read_excel('/app/benchling/screen/misc/readme.xlsx', sheet='description_column')
description_value <- read_excel('/app/benchling/screen/misc/readme.xlsx', sheet='description_value')
